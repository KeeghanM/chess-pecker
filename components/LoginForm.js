...
function LoginForm() {
    return (
      <div className="w-full lg:w-1/2 px-10">
        <div className="px-6 lg:px-20 pt-12 lg:pt-24 bg-dark text-light shadow-2xl rounded-lg">
          <form action="#" _lpchecked="1">
            <h3 className="mb-10 text-2xl font-bold font-heading">Register Account</h3>
          ...
          <div className="pt-10 flex items-center space-x-10">
              <div>Secured by</div>
              <Image className="pl-2" src="/Magic_Horizontal_White.svg" height="50px" width="100px" />
            </div>
        </div>
      </div>
    )
